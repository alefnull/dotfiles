...
bl_info = {
    ...
    'support': 'COMMUNITY',
    'category': '3D View',
    'doc_url': 'https://projects.blender.org/SMagnusson/light-painter',
    'tracker_url': 'https://projects.blender.org/SMagnusson/light-painter/issues',
}
...
operators_to_register = (
    ...
    operators.LIGHTPAINTER_OT_SkyFlag,
...
def register():
    ...
    def register_sky_types():
        operators.sky_tool.get_available_sky_types(None, bpy.context)
        return None

    # intialize so UI can display it
    bpy.app.timers.register(register_sky_types, first_interval=1.0)
    ...
    if kc:
        ...
        bpy.utils.register_tool(panel.VIEW3D_T_flag_paint, group=True)
        bpy.utils.register_tool(panel.VIEW3D_T_flag_sky_paint, after=panel.VIEW3D_T_flag_paint.bl_idname)

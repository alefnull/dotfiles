...
class BAGAPIE_OT_perforated_grid_remove(Operator):
    """ Remove Bagapie Perforated Grid modifiers """
    bl_idname = "bagapie.perforated_grid_remove"
    bl_label = 'Remove Bagapie Perforated Grid'
...
class BAGAPIE_OT_perforated_grid(Operator):
    """Turn faces into Perforated Grid"""
    bl_idname = 'bagapie.perforated_grid'
    bl_label = bagapieModifiers['perforated_grid']['label']
    bl_options = {'REGISTER', 'UNDO'}
    ...
    def execute(self, context):
        ...
        nodegroup = "BagaPie_Face_to_Perforated_Grid" # GROUP NAME
        ...
        val = {
            'name': 'perforated_grid', # MODIFIER TYPE
            'modifiers':[
...
def Collection_Add(self, context):
    ...
    array_coll = get_or_create_collection("BagaPie_Perforated_Grid", main_coll)
    
    return array_coll

classes = [
    BAGAPIE_OT_perforated_grid_remove,
    BAGAPIE_OT_perforated_grid
]